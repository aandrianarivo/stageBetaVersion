...
var formatter = (params, dataset) => {
  ...
  return {
    seriesOrder,
    stackingGroups,
    series: defaultizeValueFormatter_default(completedSeries, (v) => v.toLocaleString())
  };
};
...
function CartesianContextProvider({
  ...
  const value = React5.useMemo(() => {
    ...
    allXAxis.forEach((axis, axisIndex) => {
      ...
      const niceScale = getScale(scaleType, extremums, range2).nice(ticksNumber);
...
var ChartContainer = React11.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
...
var ResponsiveChartContainer = React12.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  ...
  return (0, import_jsx_runtime9.jsx)(ResizableContainer, {
    ...
    children: (0, import_jsx_runtime9.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    }))
...
var ChartsLine = styled_default2("line", {
  name: "MuiChartsAxis",
  slot: "Line",
...
var ChartsTick = styled_default2("line", {
  name: "MuiChartsAxis",
  slot: "Tick",
...
var ChartsTickLabel = styled_default2("text", {
  name: "MuiChartsAxis",
  slot: "TickLabel",
...
var ChartsLabel = styled_default2("text", {
  name: "MuiChartsAxis",
  slot: "Label",
...
var _excluded3 = ["scale", "ticksNumber"];
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React13.useContext(CartesianContext), _props$axisId = props.axisId, {
    xAxis: {
      [_props$axisId]: {
        scale: xScale,
        ticksNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_props$axisId], _excluded3);
  ...
  return (0, import_jsx_runtime11.jsxs)(AxisRoot, {
    ...
    }), label && (0, import_jsx_runtime10.jsx)(Label, _extends({}, labelRefPoint, {
      sx: {
...
var _excluded4 = ["scale", "ticksNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React14.useContext(CartesianContext), _props$axisId = props.axisId, {
    yAxis: {
      [_props$axisId]: {
        scale: yScale,
        ticksNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_props$axisId], _excluded4);
  ...
  return (0, import_jsx_runtime13.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime12.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime13.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime12.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime12.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          "transform-origin": `${xTickLabel}px ${yTickLabel}px`,
          sx: {
    ...
    }), label && (0, import_jsx_runtime12.jsx)(Label, _extends({}, labelRefPoint, {
      sx: {
        fontSize: labelFontSize,
...
true ? ChartsYAxis.propTypes = {
   ...
   * Id of the axis to render.
   */
  axisId: import_prop_types4.default.string.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
true ? ChartsAxis.propTypes = {
  ...
  bottomAxis: import_prop_types5.default.oneOfType([import_prop_types5.default.shape({
    axisId: import_prop_types5.default.string.isRequired,
...
function useMouseTracker() {
  ...
  const [mousePosition, setMousePosition] = React16.useState(null);
  React16.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
var ChartsTooltipPaper = styled_default2(Paper_default, {
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React17.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const Content = content != null ? content : DefaultChartsItemContent;
  return (0, import_jsx_runtime16.jsx)(Content, {
    itemData,
    series,
    sx,
    classes
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime18.jsx)("thead", {
        ...
        children: series.map(({
          ...
          children: [(0, import_jsx_runtime18.jsx)(ChartsTooltipCell, {
            ...
            className: classes.labelCell,
            children: label ? (0, import_jsx_runtime18.jsx)(Typography_default, {
              children: label
            }) : null
          }), (0, import_jsx_runtime18.jsx)(ChartsTooltipCell, {
            className: classes.valueCell,
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React18.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React18.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React18.useMemo(() => {
    return isXaxis ? xAxis[USED_AXIS_ID] : yAxis[USED_AXIS_ID];
  }, [USED_AXIS_ID, isXaxis, xAxis, yAxis]);
  const Content = content != null ? content : DefaultChartsAxisContent;
  return (0, import_jsx_runtime18.jsx)(Content, {
    axisData,
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime20.jsx)(Popper_default, {
      open: popperOpen,
...
var ChartsLegendRoot = styled_default2("g", {
  ...
  return _extends({
    "--ChartsLegend-rootOffsetX": typeof offsetX === "number" ? `${offsetX}px` : void 0,
    "--ChartsLegend-rootOffsetY": typeof offsetY === "number" ? `${offsetY}px` : void 0,
...
var ChartsSeriesLegendGroup = styled_default2("g", {
  name: "MuiChartsLegend",
...
var ChartsLegendMark = styled_default2("rect", {
  name: "MuiChartsLegend",
  slot: "Mark",
...
var ChartsLegendLabel = styled_default2("text", {
  name: "MuiChartsLegend",
  slot: "Label",
  overridesResolver: (props, styles) => styles.label
})(({
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(ChartsLegendRoot, {
    ownerState: {
      direction,
    ...
    children: seriesToDisplay.map(({
      ...
      label,
      color: color2
    }, seriesIndex) => (0, import_jsx_runtime22.jsxs)(ChartsSeriesLegendGroup, {
      ownerState: _extends({
        direction,
        seriesIndex
      }, series),
      className: classes.series,
      children: [(0, import_jsx_runtime21.jsx)(ChartsLegendMark, {
        ownerState: {
          color: color2
        },
        className: classes.mark
      }), (0, import_jsx_runtime21.jsx)(ChartsLegendLabel, {
        className: classes.label,
        children: label
      })]
    }, id))
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React20.useContext(DrawingContext);
  const series = React20.useContext(SeriesContext);
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime24.jsxs)(React22.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime23.jsx)("path", {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime23.jsx)("path", {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime23.jsx)("path", {
    ...
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime23.jsx)("path", {
...
//# sourceMappingURL=chunk-IPO4DMCL.js.map
