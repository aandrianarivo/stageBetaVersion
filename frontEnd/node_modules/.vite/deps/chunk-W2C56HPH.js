...
function useNumberInput(parameters) {
  ...
  const [value, setValue] = React34.useState(valueProp != null ? valueProp : defaultValueProp);
...
var _excluded13 = ["areOptionsEqual", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "slotProps", "slots", "value"];
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React64.useRef(false);
  const firstFocus = React64.useRef(true);
  const inputRef = React64.useRef(null);
  const listboxRef = React64.useRef(null);
  const [anchorEl, setAnchorEl] = React64.useState(null);
  const [focusedTag, setFocusedTag] = React64.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React64.useRef(defaultHighlighted);
  ...
  const resetInputValue = React64.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React64.useState(true);
  ...
  const syncHighlightedIndex = React64.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React64.useRef(false);
...
var Badge3 = React65.forwardRef(function Badge4(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime43.jsx)(BadgeSlot, _extends({}, badgeProps, {
      children: displayValue
    }))]
  }));
});
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-W2C56HPH.js.map
