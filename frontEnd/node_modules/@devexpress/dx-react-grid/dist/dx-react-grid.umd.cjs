...
(function (global, factory) {
    ...
    (global = global || self, factory((global.DevExpress = global.DevExpress || {}, global.DevExpress.DXReactGrid = {}), global.React, global.dxReactCore, global.dxGridCore, global.dxCore, global.ReactDOM));
    ...
    var VirtualTableLayout = /*#__PURE__*/ (function (_super) {
        ...
        VirtualTableLayout.prototype.storeRowHeights = function () {
            ...
            var rowsWithChangedHeights = Array.from(this.rowRefs.entries())
                ...
                return row.type !== dxGridCore.TABLE_STUB_TYPE && height !== _this.getRowHeight(row);
            });
